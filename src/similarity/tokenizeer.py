...
indexing_pipeline = TextIndexingPipeline(document_store,preprocessor=cleaner)
...
query_index_pipline = TextIndexingPipeline(document_store,preprocessor=cleaner)
